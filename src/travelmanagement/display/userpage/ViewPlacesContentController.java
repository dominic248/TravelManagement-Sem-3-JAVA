...
public class ViewPlacesContentController implements Initializable {
    ...
    void Book(ActionEvent event) {
        ...
        try {
            ViewPlaces.getChildren().add(FXMLLoader.load(getClass().getResource("/travelmanagement/display/userpage/PackageBookingContent.fxml")));
    ...
    public void getPackageData() {
        try {
            ...
            Logger.getLogger(ViewPlacesContentController.class.getName()).log(Level.SEVERE, null, ex);
        }
